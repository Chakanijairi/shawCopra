    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
          <div className="px-6 py-4 bg-[#664C36] text-white">
          ...
          <div className="p-6 space-y-3">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">View our product catalog</p>
              </div>
            </Link>
            ...
            {user?.role === 'admin' && (
              <Link
                to="/admin"
                className="flex items-center gap-3 p-4 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors bg-amber-50"
              >
